...
<title>国家水电系统</title>
<link rel="stylesheet" type="text/css" href="<%=basePath%>file/jquery-easyui-1.3.3/themes/default/easyui.css">
<link rel="stylesheet" type="text/css" href="<%=basePath%>file/jquery-easyui-1.3.3/themes/icon.css">
<script type="text/javascript" src="<%=basePath%>file/jquery-easyui-1.3.3/jquery.min.js"></script>
<script type="text/javascript" src="<%=basePath%>file/jquery-easyui-1.3.3/jquery.easyui.min.js"></script>
<script type="text/javascript" src="<%=basePath%>file/jquery-easyui-1.3.3/locale/easyui-lang-zh_CN.js"></script>
